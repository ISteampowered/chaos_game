...
fn main() {
    ...
    let purple = Point3::new(1.0, 0.0, 1.0);
    ...
    let mod_5 = |a| (a+5)%5; //make sure it's always positive
    ...
    while points.len() < 100_000 {
        ...
        while mod_5(num - previous_1) == 1 && mod_5(num - previous_2) == 4 {
            choice = *rng.choose(&choices).expect("could not choose point");
            num = point_to_num(choice);
        }
